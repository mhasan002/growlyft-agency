          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/" className="text-gray-400 hover:text-[#4CAF50] transition-colors">Home</Link></li>
                <li><Link href="/about" className="text-gray-400 hover:text-[#4CAF50] transition-colors">About</Link></li>
                <li><Link href="/services" className="text-gray-400 hover:text-[#4CAF50] transition-colors">Services</Link></li>
                <li><Link href="/why-us" className="text-gray-400 hover:text-[#4CAF50] transition-colors">Why Us</Link></li>
                <li><Link href="/blog" className="text-gray-400 hover:text-[#4CAF50] transition-colors">Blog</Link></li>
                <li><Link href="/contact" className="text-gray-400 hover:text-[#4CAF50] transition-colors">Contact</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><span className="text-gray-400">Analytics & Reporting</span></li>
              </ul>
            </div>
          </div>
          
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-400">&copy; 2025 Growlyft. All rights reserved.</p>
          </div>
        </div>
      </footer>
